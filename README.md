...
| 6    | **Video**<br>Finite Elements for simulating cloth and shells<br>[**Slides**](lectures/06-cloth-simulation-final.pdf)<br>**Research Highlight**<br>[Homogeniezd Yarn-Level Cloth](http://visualcomputing.ist.ac.at/publications/2020/HYLC/)<br>**[Assignment 4 Finite Elements for Cloth Simulation](https://github.com/dilevin/CSC417-a4-cloth-simulation) due (6/11)**
